...
export const REPORTS: ReportDef[] = [
  { key: 'daily-series', title: 'দৈনিক বিক্রয় সারসংক্ষেপ', endpoint: '/reports/daily-series', columns: [{ key: 'date', header: 'তারিখ' }, { key: 'count', header: 'বিল সংখ্যা', qty: true }, { key: 'sales', header: 'বিক্রয়', money: true }, { key: 'profit', header: 'গ্রস লাভ', money: true }, { key: 'purchases', header: 'ক্রয়', money: true }, { key: 'expenses', header: 'খরচ', money: true }], sums: ['sales', 'profit'] },
